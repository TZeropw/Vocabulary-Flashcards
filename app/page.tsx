...
const STARTER_WORDS = [
  { word: "Water", meaning: "น้ำ", category: "A1", example: "I drink water." },
  { word: "Food", meaning: "อาหาร", category: "A1", example: "I like spicy food." },
  { word: "House", meaning: "บ้าน", category: "A1", example: "This is my house." },
  { word: "Cat", meaning: "แมว", category: "A1", example: "The cat is sleeping." },
  { word: "Sun", meaning: "พระอาทิตย์", category: "A1", example: "The sun is hot." },
  { word: "Time", meaning: "เวลา", category: "A1", example: "What time is it?" },
  { word: "Journey", meaning: "การเดินทาง", category: "A2", example: "A long journey." },
  { word: "Weather", meaning: "สภาพอากาศ", category: "A2", example: "The weather is nice today." },
  { word: "Machine", meaning: "เครื่องจักร", category: "A2", example: "A washing machine." },
  { word: "Quickly", meaning: "อย่างรวดเร็ว", category: "A2", example: "He runs quickly." },
  { word: "Delicious", meaning: "อร่อย", category: "A2", example: "The food is delicious." },
  { word: "Healthy", meaning: "สุขภาพดี", category: "A2", example: "Eat healthy food." },
  { word: "Experience", meaning: "ประสบการณ์", category: "B1", example: "I have 2 years of experience." },
  { word: "Knowledge", meaning: "ความรู้", category: "B1", example: "Knowledge is power." },
  { word: "Challenge", meaning: "ความท้าทาย", category: "B1", example: "I like new challenges." },
  { word: "Improve", meaning: "ปรับปรุง/พัฒนา", category: "B1", example: "I want to improve my English." },
  { word: "Suggest", meaning: "แนะนำ", category: "B1", example: "What do you suggest?" },
  { word: "Environment", meaning: "สิ่งแวดล้อม", category: "B1", example: "Protect the environment." },
  { word: "Significant", meaning: "สำคัญ/มีนัยสำคัญ", category: "B2", example: "A significant change." },
  { word: "Analyze", meaning: "วิเคราะห์", category: "B2", example: "Analyze the data carefully." },
  { word: "Consequence", meaning: "ผลลัพธ์/ผลที่ตามมา", category: "B2", example: "Face the consequences." },
  { word: "Efficient", meaning: "มีประสิทธิภาพ", category: "B2", example: "An efficient way to work." },
  { word: "Persuade", meaning: "ชักชวน/โน้มน้าว", category: "B2", example: "Try to persuade him." },
  { word: "Complicated", meaning: "ซับซ้อน", category: "B2", example: "It's a complicated problem." },
  { word: "Ubiquitous", meaning: "มีอยู่ทุกหนทุกแห่ง", category: "C1", example: "Smartphones are ubiquitous today." },
  { word: "Meticulous", meaning: "พิถีพิถัน/ละเอียดลออ", category: "C1", example: "He is very meticulous." },
  { word: "Resilient", meaning: "ยืดหยุ่น/ฟื้นตัวเร็ว", category: "C1", example: "A resilient economy." },
  { word: "Ambiguous", meaning: "กำกวม/คลุมเครือ", category: "C1", example: "An ambiguous answer." },
  { word: "Inevitable", meaning: "ซึ่งหลีกเลี่ยงไม่ได้", category: "C1", example: "It was an inevitable result." },
  { word: "Crucial", meaning: "สำคัญมาก/วิกฤต", category: "C1", example: "A crucial decision." }
];
